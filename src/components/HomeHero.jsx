        ...
        <>
            ...
            <div className='relative overflow-hidden flex flex-col justify-evenly h-screen w-full sm:px-8'>
                ...
                <div className='h-full flex flex-col justify-evenly z-20'>
                    ...
                    <div className={`text-center flex flex-col sm:flex-row justify-center items-center gap-3 -mt-8 ${animate ? 'anim-fade-up-3' : 'opacity-0'}`}>
                        <Link to='/contact_us' className='font-semibold text-sm py-4 px-8 bg-[#C8A96B] hover:bg-white transition-all duration-300 ease-in-out'>
                            EXPLORE STORIES
                        </Link>
